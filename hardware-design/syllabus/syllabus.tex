...
Tests are graded using standards-based grading.

The course is broken down into eight standards. All standards are weighted equally.

You will have two opportunities to demonstrate proficiency on each standard: the test and the final.

If you demonstrate proficiency on the test, you get to skip that part of the final.


Assignments on Doenet. Some of them will be graded automatically. Some stuff you work out on paper, etc, and submit a PDF via Moodle.

Peer reviews. Short. Less than one page.

You can get full credit here without too much trouble. Show up. Work together. Make it easy for your peers to say nice things about you.

I recommend keeping notes during the semester when someone is particularly helpful, insightful, etc. The strongest reviews include concrete examples.
...
There is one assignment per standard. They are found on Doenet. Some parts of the assignment will be graded automatically by Doenet. Other parts will be submitted as a PDF via Moodle.

You will have time each day to work on these assignments in class. Please take advantage of this time to work together and ask questions. 

You are encouraged to work together with your peers, both in class and independently. Please ensure that the work you turn in reflects your own understanding.

\subsection{Late Work Policy}

Please try to get your work in on time. Otherwise you are likely to fall behind in the course.

Late work is inconvenient for the TAs. They may be grumpy and vindictive when grading late work.

No late work will be accepted for the last two weeks of the semester. The TAs have their own finals to worry about!

When submitting late work, you must notify the grader(s) by email. Otherwise they will not know to look for it.
