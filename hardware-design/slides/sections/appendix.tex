...
\begin{frame}{Laptop Setup: Enable WiFi}
	USB 10/100/1000 is the Pi ethernet connection. It does not provide internet. Make sure WiFi is listed first!
	\includegraphics[width=0.7\columnwidth]{images/pi-network-settings}
\end{frame}

\begin{frame}{Laptop Setup: Install VSCode}
\end{frame}

\begin{frame}{Laptop Setup: Install Remote SSH Extension}
