...
\begin{frame}[fragile]{We'll talk more about these ones later}
	...
	\Arm{bl} stands for "branch and link". More on that later
...
\begin{frame}[fragile]{Printf in Assembly}
	The idea is exactly the same in Assembly. The syntax is just a bit more rustic:
