...
\begin{frame}[fragile]{Output with Printf}
	\begin{itemize}
		\item We use \texttt{printf} to print output to the terminal
		\item This same functionality exists in other languages, sometimes under the same name
	\end{itemize}

	Example in C for legibility
...
\begin{frame}{Favorite Number}
	\begin{itemize}
		\item This code is very similar to the earlier hello world code
