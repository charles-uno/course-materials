...
\begin{frame}{Disability Accommodation}
...
\begin{frame}{Required Referrals}
	...
	\begin{itemize}
		\item \href{https://wp.stolaf.edu/counseling-center/}{Boe House Counseling Center}
		\item \href{https://wp.stolaf.edu/ministry/}{College Pastors and Chaplains}
		\item \href{https://pages.stolaf.edu/sarn/}{Sexual Assault Resource Network (SARN)}
		\item \href{https://wp.stolaf.edu/health/}{Health Services}
		\item \href{https://wp.stolaf.edu/timelycare/}{TimelyCare}
	\end{itemize}
\end{frame}
...
\begin{frame}{Important Links}
	\begin{itemize}
		\item Textbook: https://diveintosystems.org/book/index.html
		\item ARM tutorial https://diveintosystems.org/book/C9-ARM64/index.html
		% arm7: https://computerscience.chemeketa.edu/armTutorial/index.html
		\item ARM simulator http://163.238.35.161/~zhangs/arm64simulator/
		% arm7: https://cpulator.01xz.net/?sys=arm
		\item circuit simulator: https://circuitverse.org/simulator
		\item circuit simulator tutorial: https://docs.google.com/document/d/1gyrmqpMgUCC-TbXVvV8rMXqGMoWEvJtxQ8oh3twlC5Y/edit?usp=sharing
	\end{itemize}
\end{frame}
