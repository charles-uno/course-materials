...
% doing our best to not worry about SIMD or alignment... but we do still have to worry about it with ascii constants


\begin{frame}[fragile]{stack frame proof of concept}
	\begin{multicols}{2}
		{\small
			\begin{minted}{arm}
.section .rodata
