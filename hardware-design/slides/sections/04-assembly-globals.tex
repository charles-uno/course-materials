...
\begin{frame}[fragile]{Global Constants}
	...
	\begin{itemize}
		...
		\item Use the name to load the \emph{address}
		\item Value does not change
		\item Types we will use: \Arm{word} and \Arm{ascii}
		\item Use \Arm{.align 2} after \Arm{ascii} literals
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Global Variables}
	\begin{minted}{arm}
		...
		\end{minted}
	\begin{itemize}
		\item Not constant (it can change)
		\item Otherwise just like a global constant
	\end{itemize}
\end{frame}
